export default {
  ...
  <div v-if="question.options.textother" id="choice-other" :class="{button: true, selected: question.answer.other }" @input="$emit('selectedother')" @click="$emit('selectedother')">
    <input type="text">
  </div>
  `
}